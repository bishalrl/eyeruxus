...
class RoomBubblePage extends StatefulWidget {
  @override
  _RoomBubblePageState createState() => _RoomBubblePageState();
}

class _RoomBubblePageState extends State<RoomBubblePage> {
  String? selectedItemId;

  final List<RoomBubbleItem> RoomBubbleItems = [
    RoomBubbleItem(
      id: '1',
      name: 'Crystal Flower Spirit Pattern',
      price: 12,
      imageUrl: 'Assets/RoomBubble.png',
      isObtained: false,
      currency: 'coins',
    ),
    RoomBubbleItem(
  ...
  RoomBubbleItem? get selectedItem {
    if (selectedItemId == null) return null;
    return RoomBubbleItems.firstWhere((item) => item.id == selectedItemId);
  }
  ...
  void initState() {
    ...
    selectedItemId = RoomBubbleItems.first.id;
  }
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: RoomBubbleItems.length,
                          itemBuilder: (context, index) {
                            final item = RoomBubbleItems[index];
