...
class PartyThemePage extends StatefulWidget {
  @override
  _PartyThemePageState createState() => _PartyThemePageState();
}

class _PartyThemePageState extends State<PartyThemePage> {
  ...
  ThemeItem? get selectedItem {
    if (selectedItemId == null) return null;
    return themeItems.firstWhere((item) => item.id == selectedItemId);
  }
  ...
  void initState() {
    ...
    selectedItemId = themeItems.first.id;
  }
